...
export declare type AuthRedirectResult = {
...
export declare type DataProvider<ResourceType extends string = string> = {
    ...
    getOne: <RecordType extends RaRecord = any>(resource: ResourceType, params: GetOneParams<RecordType>) => Promise<GetOneResult<RecordType>>;
...
export declare type onError = OnError;
